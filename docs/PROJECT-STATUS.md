...
2026-09-25 — Claude Code (gaming page)
...
- [x] `/gaming/` rebuilt as a paper pinboard (taped polaroid, ID tickets, era timeline) after the neon arcade version was rejected. Valorant stuartboi#0702, Discord stuart07026699, Steam StuartBoi07 by SteamID64. The avatar keeps its separate `#g-*` parts driven by `js/gamer.js`.
